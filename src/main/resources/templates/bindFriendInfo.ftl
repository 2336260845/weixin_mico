...
<form name="form1" onSubmit="return checkreg()" action="${ctx!}/api/v1/wechat/friend/bind" method="post">
	<div class="div_f">
		<div class="div_col" id="me">
			<div class="div_c_l"><span>朋友姓名</span>
			</div>
			<div class="div_c_r"><input type="text" name="name" id="name" placeholder="请填写真实姓名">
				<span style="float: right;margin-top: -30px;background:#fff" id="sp_name"></span></input>
			</div>
		</div>
	...
	<div class="div_f">
		<div class="div_col" id="me">
			...
			<div class="div_c_r"><input type="tel" name="card" id="card" onKeyDown="" value="" placeholder="室友/同学/朋友/恋人一卡通均可">
    ...
    <div class="div_f">
        <div class="div_col" id="me">
            <div class="div_c_l"><span style="width:70px;">电子邮箱</span>
            </div>
            <div class="div_c_r"><input type="text" id="email" name="email" onkeydown="" id="email" value="" placeholder="建议QQ邮箱">
