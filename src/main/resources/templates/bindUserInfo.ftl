...
<form name="form1" onSubmit="return checkreg()" action="${ctx!}/api/v1/wechat/user/login" method="post">
    <div class="div_f">
        <div class="div_col" id="me">
            ...
            <div class="div_c_r"><input type="text" name="name" id="name" placeholder="请填写真实姓名">
                <span style="float: right;margin-top: -30px;background:#fff" id="sp_user"></span></input>
            </div>
        </div>
    ...
    <div class="div_f">
        <div class="div_col" id="me">
            ...
            <div class="div_c_r"><input type="tel" name="card" id="card" onKeyDown="" value="" placeholder="请输入一卡通，为了在微信快速精准推送给您">
    ...
    <div class="div_f">
        <div class="div_col" id="me">
            ...
            <div class="div_c_r"><input type="tel" id="phone" name="phone" onkeydown="" id="phone" value="" placeholder="请输入手机号码">
                <span style="float: right;margin-top: -30px;background:#fff" id="sp_phone"></span>
            </div>
        </div>
        <div style="clear:both"></div>
    </div>
    ...
    <div class="div_f">
        <div class="div_col" id="me">
            <div class="div_c_l"><span style="width:70px;">QQ邮箱</span>
            </div>
            <div class="div_c_r"><input type="text" id="email" name="email" onkeydown="" id="email" value="" placeholder="为了在QQ快速精准推送给您">
                <span style="float: right;margin-top: -30px;background:#fff" id="sp_email"></span>
            </div>
        </div>
        <div style="clear:both"></div>
    </div>
...
<script type="text/javascript">
   ...
   // document.getElementById("code").value = code;
    ...
    function checkreg() {
        ...
        var telePhone = document.form1.phone.value;
        var email = document.form1.email.value;
        var cardNumber = document.form1.card.value;

        if(userName == "" || telePhone == "" || email == "" || cardNumber == ""){
            if(userName == ""){
                document.getElementById("sp_user").innerHTML = "<font color='red'>请输入您的用户名!</font>";
                form1.name.focus();
                return false;
            }else if(cardNumber == ""){
                ...
                document.getElementById("sp_phone").innerHTML = "<font color='red'>请输入手机号码</font>";
                document.form1.phone.focus();
                return false;
            }else if(email == ""){
                //alert("请输入您的用户名!");
                document.getElementById("sp_email").innerHTML = "<font color='red'>请输入您的邮箱!</font>";
                form1.name.focus();
                return false;
            }
            return false;
